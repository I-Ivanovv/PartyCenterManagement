        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServiceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Serv = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GLastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_UserProfile_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.InsertData(
                table: "Packages",
                columns: new[] { "PackageID", "MaxGuests", "MaxLength", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 40, 2, "Standard", 150 },
                    { 2, 60, 4, "Premium", 250 },
                    { 3, null, null, "Ultra", 350 }
                });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "ServiceID", "Serv" },
                values: new object[,]
                {
                    { 1, "Entertainer" },
                    { 2, "Cake" },
